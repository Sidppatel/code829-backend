...
- For projections/aggregations: prefer a view (`v_*`) registered in `OnModelCreating` and queried through its DbSet. **This is the preferred pattern for all read-heavy API endpoints.**
