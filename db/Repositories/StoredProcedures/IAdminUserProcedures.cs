...
public interface IAdminUserProcedures
{
    ...
    Task<Guid?> SetAdminUserImageAsync(Guid adminUserId, Guid imageId, CancellationToken ct = default);
    Task<Guid?> ClearAdminUserImageAsync(Guid adminUserId, CancellationToken ct = default);
