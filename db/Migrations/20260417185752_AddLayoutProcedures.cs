...
");
            ...
            // ─── Layout lock / booking check procedures ────────────────
...
RETURNS TABLE(""Id"" uuid) LANGUAGE sql STABLE AS $$
    SELECT DISTINCT b.""TableId"" FROM bookings b
    WHERE b.""EventId"" = p_event_id
      AND b.""TableId"" IS NOT NULL
      AND b.""Status"" IN ('Paid', 'CheckedIn', 'Pending')
    UNION
...
");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS sp_event_table_has_active_bookings(uuid, uuid);");
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS sp_event_has_active_bookings(uuid);");
